...
3. **选择分类**: 
   - 选择分类级别数量（支持1-5级）
   - 为每个级别选择对应的字段索引（从0开始计数）
   - 系统会实时预览分类效果

4. **预览下载**: 查看分类结果并下载ZIP压缩包
...
- 分隔符: `_`
- 分类级别: 2级
- 第1级选择索引1: 将按 `code1`, `code2`, `code3` 分类
- 第2级选择索引3: 将在每个一级文件夹下按公司名称分类
...
**提示**: 系统支持1-5级分类，您可以根据实际需求灵活配置分类级别和字段索引。
...
2. 文件大小建议控制在100MB以内
3. 分类字段索引从0开始计数
4. 系统支持1-5级自定义分类，可根据需要灵活配置
5. 系统会自动处理文件名中的特殊字符
6. 系统已集成Google Analytics进行使用数据分析
